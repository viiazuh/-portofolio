import { Database, Smartphone, Layout, ChevronRight, Globe } from 'lucide-react'; // Tambahkan Globe jika ingin icon bola dunia
...
const ProjectCard = ({ title, description, stack, link, icon }) => (
    <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100 hover:shadow-xl hover:border-amber-400 transition-all duration-300 group">
        ...
        <p className="text-slate-600 mb-4 text-base line-clamp-3">{description}</p>
...
const Projects = () => {
    const projects = [
        // PROJECT BARU DITAMBAHKAN DI SINI (URUTAN PERTAMA)
        { 
            title: "Sistem Informasi Dusun", 
            description: "Digitalisasi pengumuman warga & dokumentasi desa dengan Dashboard Admin real-time.", 
            stack: ["React", "Firebase", "Cloudinary", "Dashboard"], 
            link: "https://github.com/viiazuh/Web-Kadus-VII-Sei-Rotan",
            icon: <Layout size={24} /> 
        },
        { 
            title: "ML Prediction Deployment", 
            description: "Web monitor diabetes dengan Flask & Docker.", 
            stack: ["Flask", "Docker", "CI/CD", "React"], 
            link: "https://github.com/viiazuh/diabetes-app_UTsDevops", 
            icon: <Database size={24} /> 
        },
        { 
            title: "Mobile E-Wallet", 
            description: "Aplikasi E-Wallet dengan Flutter UI/UX.", 
        ...
        { 
            title: "25 Kisah Nabi", 
            description: "Aplikasi Android Native Kotlin.", 
            stack: ["Kotlin", "Android Native"], 
            link: "https://github.com/viiazuh/25-prophets", 
            icon: <Smartphone size={24} /> 
        },
        { 
            title: "PASA: Password Security", 
            description: "Tim project deteksi keamanan password (ML).", 
    ...
    return (
        <div className="pt-12 pb-24 animate-fade-in-up">
            <header className="mb-10 text-center">
                <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-2">Featured <span className="text-amber-500">Projects</span></h2>
                <p className="text-lg text-slate-600">Karya terbaik saya.</p>
            </header>
