    ...
    return (
        <div className="pt-12 pb-24 animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <SkillCard title="Full-Stack Development" description="Membangun aplikasi web mulai dari UI (FE) hingga logic server (BE) dan Database." techs={["React", "Vue.js", "Flask (Python)", "Node.js (Express)", "MySQL", "SQLite 3", "RESTful API"]} icon={<Layout size={24} />} />
                ...
                <SkillCard title="Deployment & CI/CD" description="Otomatisasi pengiriman kode ke produksi, manajemen container, dan hosting ML Model." techs={["Docker", "GitHub Actions", "GitLab CI/CD", "Linux Server Mgmt", "MLOps Basics"]} icon={<Zap size={24} />} />
                <SkillCard title="Tools & Utility" description="Peralatan yang digunakan sehari-hari untuk meningkatkan efisiensi dan kolaborasi kerja." techs={["Git", "Tailwind CSS", "Bootstrap", "VS Code", "Postman", "Figma Basics"]} icon={<Code size={24} />} />
            </div>
        </div>
    );
};
